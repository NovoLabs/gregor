(ns gregor.core
  "Thre main user interface to gregor, which is asyncrhonous."
  (:require [clojure.core.async :as a]
            [gregor.client :as client]
            [gregor.util :as util])
...
"
  ...
  ([config kd vd]
   (let [topic     (:topic config)
         ...
         driver    (make-consumer (dissoc config :topic) kd vd)
